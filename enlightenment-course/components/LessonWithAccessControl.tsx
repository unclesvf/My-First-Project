...
import { checkLessonAccess, getFreeLessonsCount, isLessonFree } from "@/lib/utils/accessControl";
    ...
    <div className="flex min-h-screen flex-col">
      <div className="flex flex-1 items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mb-6 text-gray-600">
            {accessDeniedReason ||
              `Only the first ${getFreeLessonsCount()} lessons are free. Please purchase access or start a free trial.`}
          </p>
          <button
            onClick={() =>
              typeof window !== "undefined" && window.history.back()
