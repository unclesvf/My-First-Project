...
export default function FlashcardDeck({ flashcards, lessonId }: FlashcardDeckProps) {
  ...
  const toggleMastered = () => {
    // Use the actual flashcard ID, not the index, so mastered state survives shuffling
  ...
  // Check mastered state using actual card ID, not index
  const isCurrentCardMastered = masteredCards.has(cards[currentIndex].id);
